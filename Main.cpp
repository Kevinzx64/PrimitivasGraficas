...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "Graficas de Computadoras de manera Estructurada",
		NULL, NULL); 
	...
	unsigned char* bytes = stbi_load("CatBug.jpg", &widthImg, &heightImg, &numColCh, 0); // Aqui colocas la textura
